...
public class Home_excercise_5 {
        ...
        public static boolean isPalindrome (String nextText) {
            ...
            //AAAAAAA!!! I have just seen, if you delete symbol [0] in your reverse word - the function
            // stringReverse(String nextText) stops to work. I think, the symbol [0] is that "\u202E"!!! Maybe need to
            // get empty symbol [0] for original word for correctly work .equals.
            // I have checked - added empty "" - NO, .equals not works(((((( Maybe need to change Reverse method.
            String youRevStr = stringReverse(nextText.trim().toUpperCase());
